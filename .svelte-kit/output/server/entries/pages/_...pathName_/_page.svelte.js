...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<title>${escape(postName)}</title> <div class="md:w-[26rem] lg:w-[36rem] mx-auto md:p-0 px-5 svelte-iwus63"><div class="mb-5 px-1 svelte-iwus63"><h1 class="text-lg font-semibold">${escape(postName)}</h1> <div class="mb-2 svelte-iwus63"><i class="mr-3">${escape(publishDate.toDateString())}</i> ${each(postTags, (tag) => {
